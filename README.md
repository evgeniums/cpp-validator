...
Modern C++ header-only library for validation of variables, objects and containers. The library can be used with various platforms and compilers that support C++14 and/or C++17 standards. 
