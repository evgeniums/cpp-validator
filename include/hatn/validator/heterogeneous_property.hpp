...
#ifndef HATN_VALIDATOR_HETEROGENEOUS_PROPERTY_HPP
#define HATN_VALIDATOR_HETEROGENEOUS_PROPERTY_HPP
...
#define HATN_VALIDATOR_HETEROGENEOUS_PROPERTY_FLAG(prop,index,flag_dscr,n_flag_dscr) \
    ...
    struct type_p_##prop : public HATN_VALIDATOR_NAMESPACE::heterogeneous_property_with_config_t<index,heterogeneous_p_conf_##prop> \
    { \
        using HATN_VALIDATOR_NAMESPACE::heterogeneous_property_with_config_t<index,heterogeneous_p_conf_##prop> \
    ...
    { \
        return HATN_VALIDATOR_NAMESPACE::make_property_validator(prop,std::forward<Args>(args)...); \
    }

#define HATN_VALIDATOR_HETEROGENEOUS_PROPERTY(prop,index) HATN_VALIDATOR_HETEROGENEOUS_PROPERTY_FLAG(prop,index,nullptr,nullptr)

//-------------------------------------------------------------

HATN_VALIDATOR_NAMESPACE_END

#endif // HATN_VALIDATOR_HETEROGENEOUS_PROPERTY_HPP
