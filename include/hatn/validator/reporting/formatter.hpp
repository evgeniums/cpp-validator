...
#ifndef HATN_VALIDATOR_FORMATTER_HPP
#define HATN_VALIDATOR_FORMATTER_HPP
 ...
 * a preferred backend formatter but it requires a fmt library available in include paths and HATN_VALIDATOR_FMT
 * macro defined.
 *
 */
...
#endif // HATN_VALIDATOR_FORMATTER_HPP
