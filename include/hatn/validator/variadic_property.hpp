...
#ifndef HATN_VALIDATOR_VARIADIC_PROPERTY_HPP
#define HATN_VALIDATOR_VARIADIC_PROPERTY_HPP
...
#define HATN_VALIDATOR_VARIADIC_PROPERTY_HF(prop,has_prop,flag_dscr,n_flag_dscr) \
...
struct type_variadic_p_##prop : public HATN_VALIDATOR_NAMESPACE::variadic_property_base_tag, public HATN_VALIDATOR_NAMESPACE::basic_property \
{ \
    ...
    { \
        ...
        auto arg_types=HATN_VALIDATOR_NAMESPACE::class_method_args<decltype(&std::decay_t<decltype(v)>::prop)>::types(); \
        return HATN_VALIDATOR_NAMESPACE::variadic_property_closure< \
...
#define HATN_VALIDATOR_VARIADIC_PROPERTY(prop) HATN_VALIDATOR_VARIADIC_PROPERTY_HF(prop,always_has_property,nullptr,nullptr)
#define HATN_VALIDATOR_VARIADIC_PROPERTY_HAS(prop,has) HATN_VALIDATOR_VARIADIC_PROPERTY_HF(prop,has,nullptr,nullptr)
#define HATN_VALIDATOR_VARIADIC_PROPERTY_FLAG(prop,flag_dscr,n_flag_dscr) HATN_VALIDATOR_VARIADIC_PROPERTY_HF(prop,always_has_property,flag_dscr,n_flag_dscr)

//-------------------------------------------------------------

HATN_VALIDATOR_NAMESPACE_END

#endif // HATN_VALIDATOR_VARIADIC_PROPERTY_HPP
