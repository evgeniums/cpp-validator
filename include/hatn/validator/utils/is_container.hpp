...
#ifndef HATN_VALIDATOR_IS_CONTAINER_HPP
#define HATN_VALIDATOR_IS_CONTAINER_HPP
...
HATN_VALIDATOR_INLINE_LAMBDA auto has_begin_c = hana::is_valid([](auto&& v) -> decltype(
...
HATN_VALIDATOR_INLINE_LAMBDA auto has_end_c = hana::is_valid([](auto&& v) -> decltype(
                                                            (void)hana::traits::declval(v).begin()
                                                           )
                                                        {});
/**
...
#endif // HATN_VALIDATOR_IS_CONTAINER_HPP
